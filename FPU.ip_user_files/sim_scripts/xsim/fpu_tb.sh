...
#
# Script generated by Vivado on Mon Oct 13 23:16:03 +0530 2025
...
#
# Usage        : fpu_tb.sh
#                fpu_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fpu_tb.sh [-reset_run]
#                fpu_tb.sh [-reset_log]
#                fpu_tb.sh [-help]
#
...
# script info
echo -e "fpu_tb.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fpu_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot fpu_tb xil_defaultlib.fpu_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fpu_tb -key {Behavioral:sim_1:Functional:fpu_tb} -tclbatch cmd.tcl -protoinst "protoinst_files/fpu_addsub.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fpu_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fpu_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fpu_tb.sh [-help]\n\
Usage: fpu_tb.sh [-step]\n\
Usage: fpu_tb.sh [-lib_map_path]\n\
Usage: fpu_tb.sh [-reset_run]\n\
Usage: fpu_tb.sh [-reset_log]\n\
Usage: fpu_tb.sh [-keep_index]\n\
Usage: fpu_tb.sh [-noclean_files]\n\n\
