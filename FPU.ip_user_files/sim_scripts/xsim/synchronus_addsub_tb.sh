...
#
# Script generated by Vivado on Tue Oct 14 11:13:31 +0530 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : synchronus_addsub_tb.sh
...
#
# Usage        : synchronus_addsub_tb.sh
#                synchronus_addsub_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                synchronus_addsub_tb.sh [-reset_run]
#                synchronus_addsub_tb.sh [-reset_log]
#                synchronus_addsub_tb.sh [-help]
#
...
# script info
echo -e "synchronus_addsub_tb.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./synchronus_addsub_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot synchronus_addsub_tb xil_defaultlib.synchronus_addsub_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim synchronus_addsub_tb -key {Behavioral:sim_1:Functional:synchronus_addsub_tb} -tclbatch cmd.tcl -protoinst "protoinst_files/fpu_addsub.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/Viv/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb synchronus_addsub_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./synchronus_addsub_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: synchronus_addsub_tb.sh [-help]\n\
Usage: synchronus_addsub_tb.sh [-step]\n\
Usage: synchronus_addsub_tb.sh [-lib_map_path]\n\
Usage: synchronus_addsub_tb.sh [-reset_run]\n\
Usage: synchronus_addsub_tb.sh [-reset_log]\n\
Usage: synchronus_addsub_tb.sh [-keep_index]\n\
Usage: synchronus_addsub_tb.sh [-noclean_files]\n\n\
